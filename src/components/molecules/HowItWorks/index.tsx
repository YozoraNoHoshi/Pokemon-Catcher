...
function HowItWorks(props: Width): JSX.Element {
  return (
    <Flex column alCenter cWidth={props.cWidth}>
      <p>
      ...
      <p>
        ...
        Pokemon in the park, including how difficult they are to catch and their
        location.
      </p>
      <p>
        Finally, each guest is given a journal to record their progress. Please
        be sure to write in it often!
      </p>
    </Flex>
  );
}
